                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="text-align: center;">
                    ...
                    @else
                        <ul class="navbar-nav" style="float: none;">
                            <li class="nav-item">
                                <a class="btn btn-app btn-primary " style="margin-right:5px" href="{{route('home')}}"><i class="fa fa-edit" style="padding-right:5px"></i><b>Solicitar</b><span class="sr-only"></span></a>
                            </li>
                            <li class="nav-item mr-auto">
                                <a class="btn btn-app btn-secondary" style="margin-right:5px" href="{{route('listar')}}"><i class="fa fa-list" style="padding-right:5px"></i><b>Listar</b><span class="sr-only"></span></a>
                            </li>
                            @if(auth()->user()->admin == 'sim')
                                <li class="nav-item mr-auto">
                                    <a class="btn btn-app btn-warning" style="margin-right:5px" href="{{route('listarADM')}}"><i class="fa fa-list" style="padding-right:5px"></i><b>Listar ADM</b><span class="sr-only"></span></a>
                                </li>
                            @endif
                            <li class="nav-item mr-auto">
